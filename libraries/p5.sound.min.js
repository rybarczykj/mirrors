...
!(function (n) {
    ...
    function (t, e, n) {
        ...
        void 0 ===
            (i = function () {
                ...
                var e;
                return (
                    (l.prototype.set = function (t, e, n) {
                        ...
                        t: for (var r in t) {
                            ...
                            var c = o[r];
                            this.isUndef(c) ||
                                ((l.Signal && c instanceof l.Signal) ||
                                (l.Param && c instanceof l.Param)
                                    ? c.value !== e &&
                                      (this.isUndef(n)
                                          ? (c.value = e)
                                          : c.rampTo(e, n))
                    ...
                    (l.prototype._collectDefaults = function (t) {
                        var e = [];
                        if (
                            (this.isUndef(t.defaults) ||
                                (e = Object.keys(t.defaults)),
                    ...
                    (AudioNode.prototype.chain = l.prototype.chain),
                    (AudioNode.prototype.fan = l.prototype.fan),
                    (l.prototype.defaultArg = function (t, e) {
                    ...
                    (l.noOp = function () {}),
                    (l.prototype._readOnly = function (t) {
                        if (Array.isArray(t))
                    ...
                    Object.defineProperty(l, 'context', {
                        ...
                        set: function (t) {
                            (e =
                                l.Context && t instanceof l.Context
                                    ? t
                                    : new l.Context(t)),
                                l.Context && l.Context.emit('init', e);
                        },
                    }),
                        ...
                        (e.Multiply = function (t) {
                            this.createInsOuts(2, 0),
                                (this._mult =
                                    ...
                                    this.output =
                                        new e.Gain()),
                                (this._param = this.input[1] =
                                    this.output.gain),
                                (this._param.value = this.defaultArg(t, 0));
                        }),
                        e.extend(e.Multiply, e.Signal),
                        (e.Multiply.prototype.dispose = function () {
                            return (
            ...
            void 0 ===
                (r = function (e) {
                    ...
                    return (
                        ...
                        e.extend(e.Signal, e.Param),
                        (e.Signal.defaults = {
                            value: 0,
                            units: e.Type.Default,
                            convert: !0,
                        }),
                        (e.Signal.prototype.connect =
                            e.SignalBase.prototype.connect),
                        (e.Signal.prototype.dispose = function () {
                            return (
                                e.Param.prototype.dispose.call(this),
                                (this._param = null),
    ...
    function (t, u, c) {
        ...
        (function (t) {
            ...
            function a(t, e) {
                var n = t;
                return (
                    t instanceof p5.Element
                        ? (n = t.elt)
                        : t instanceof Array &&
                          t[0] instanceof p5.Element &&
                          (n = t.map(function (t) {
                              return t.elt;
                          })),
                    i()(o, n, e)
                        ...
                        (e.Add = function (t) {
                            this.createInsOuts(2, 0),
                                (this._sum =
                                    ...
                                    this.output =
                                        new e.Gain()),
                                (this._param = this.input[1] = new e.Signal(t)),
                                this._param.connect(this._sum);
                        }),
                        e.extend(e.Add, e.Signal),
                        (e.Add.prototype.dispose = function () {
                            return (
                                e.prototype.dispose.call(this),
                                this._sum.dispose(),
                                (this._sum = null),
                            ...
                            (this._shaper =
                                ...
                                Array.isArray(t)
                                    ...
                                    ? (this._curve = new Float32Array(
                                          this.defaultArg(t, 1024),
                                      ))
                                    : this.isFunction(t) &&
                                      ((this._curve = new Float32Array(
                                          this.defaultArg(e, 1024),
                                      )),
                                      this.setMap(t));
                        }),
        ...
        (i = [n(0), n(2), n(19)]),
            void 0 ===
                (r = function (u) {
                    'use strict';
                    return (
                        (u.TimelineSignal = function () {
                            var t = this.optionsObject(
                                arguments,
                                ['value', 'units'],
                                u.Signal.defaults,
                            );
                            (this._events = new u.Timeline(10)),
                                u.Signal.apply(this, t),
                                (t.param = this._param),
                                u.Param.call(this, t),
                                (this._initial = this._fromUnits(
                                    this._param.value,
                                ));
                        }),
                        u.extend(u.TimelineSignal, u.Param),
                        (u.TimelineSignal.Type = {
                            Linear: 'linear',
                        ...
                        (u.TimelineSignal.prototype.setValueAtTime = function (
                            t,
                            e,
                        ) {
                            return (
                        ...
                        (u.TimelineSignal.prototype.linearRampToValueAtTime =
                            function (t, e) {
                                return (
                                    (t = this._fromUnits(t)),
                                    (e = this.toSeconds(e)),
                        ...
                        (u.TimelineSignal.prototype.exponentialRampToValueAtTime =
                            function (t, e) {
                                e = this.toSeconds(e);
                        ...
                        (u.TimelineSignal.prototype.setTargetAtTime = function (
                            t,
                            e,
                            n,
                        ) {
                        ...
                        (u.TimelineSignal.prototype.setValueCurveAtTime =
                            function (t, e, n, i) {
                                i = this.defaultArg(i, 1);
                                for (
                                    var r = new Array(t.length), o = 0;
                                    o < r.length;
                                    o++
                                )
                                    r[o] = this._fromUnits(t[o]) * i;
                                (e = this.toSeconds(e)),
                                    (n = this.toSeconds(n)),
                                    this._events.add({
                        ...
                        (u.TimelineSignal.prototype.cancelScheduledValues =
                            function (t) {
                                return (
                                    (t = this.toSeconds(t)),
                        ...
                        (u.TimelineSignal.prototype.setRampPoint = function (
                            t,
                        ) {
                            t = this.toSeconds(t);
                            ...
                            if (n && n.time === t)
                                this.cancelScheduledValues(t + this.sampleTime);
                            else if (
                                n &&
                                n.type === u.TimelineSignal.Type.Curve &&
                                n.time + n.duration > t
                            )
                                ...
                                i &&
                                    (this.cancelScheduledValues(t),
                                    i.type === u.TimelineSignal.Type.Linear
                                        ? this.linearRampToValueAtTime(e, t)
                                        : i.type ===
                                              u.TimelineSignal.Type
                                                  .Exponential &&
                        ...
                        (u.TimelineSignal.prototype.linearRampToValueBetween =
                            function (t, e, n) {
                                return (
                                    this.setRampPoint(e),
                                    this.linearRampToValueAtTime(t, n),
                                    this
                                );
                            }),
                        (u.TimelineSignal.prototype.exponentialRampToValueBetween =
                            function (t, e, n) {
                                return (
                                    this.setRampPoint(e),
                                    this.exponentialRampToValueAtTime(t, n),
                                    this
                                );
                            }),
                        (u.TimelineSignal.prototype._searchBefore = function (
                            t,
                        ) {
                            return this._events.get(t);
                        }),
                        (u.TimelineSignal.prototype._searchAfter = function (
                            t,
                        ) {
                            return this._events.getAfter(t);
                        }),
                        (u.TimelineSignal.prototype.getValueAtTime = function (
                            t,
                        ) {
                            t = this.toSeconds(t);
                            ...
                            if (null === n) i = this._initial;
                                ...
                                var r,
                                    o = this._events.getBefore(n.time);
                                (r = null === o ? this._initial : o.value),
                                ...
                                i =
                                    n.type === u.TimelineSignal.Type.Curve
                                        ...
                                        : e.type ===
                                          u.TimelineSignal.Type.Exponential
                        ...
                        (u.TimelineSignal.prototype.connect =
                            u.SignalBase.prototype.connect),
                        (u.TimelineSignal.prototype._exponentialApproach =
                            function (t, e, n, i, r) {
                                return n + (e - n) * Math.exp(-(r - t) / i);
                            }),
                        (u.TimelineSignal.prototype._linearInterpolate =
                            function (t, e, n, i, r) {
                                return e + ((r - t) / (n - t)) * (i - e);
                            }),
                        (u.TimelineSignal.prototype._exponentialInterpolate =
                            function (t, e, n, i, r) {
                                return (
                                    (e = Math.max(this._minOutput, e)) *
                                    Math.pow(i / e, (r - t) / (n - t))
                                );
                            }),
                        (u.TimelineSignal.prototype._curveInterpolate =
                            function (t, e, n, i) {
                                var r = e.length;
                        ...
                        (u.TimelineSignal.prototype.dispose = function () {
                            u.Signal.prototype.dispose.call(this),
                                u.Param.prototype.dispose.call(this),
                    ...
                    return (
                        (n.Scale = function (t, e) {
                            (this._outputMin = this.defaultArg(t, 0)),
                                ...
                                (this._scale = this.input = new n.Multiply(1)),
                                (this._add = this.output = new n.Add(0)),
                                this._scale.connect(this._add),
                                this._setRange();
                        }),
                        n.extend(n.Scale, n.SignalBase),
                        Object.defineProperty(n.Scale.prototype, 'min', {
                            get: function () {
                        ...
                        (n.Scale.prototype._setRange = function () {
                            (this._add.value = this._outputMin),
                                (this._scale.value =
                                    this._outputMax - this._outputMin);
                        }),
                    ...
                    return (
                        ...
                        (e.prototype.toSeconds = function (t) {
                            return this.isNumber(t)
                                ...
                                ? this.now()
                                : this.isString(t)
                                ? new e.Time(t).toSeconds()
                                : t instanceof e.TimeBase
                                ? t.toSeconds()
                                : void 0;
                        }),
                        (e.prototype.toFrequency = function (t) {
                            return this.isNumber(t)
                                ? t
                                : this.isString(t) || this.isUndef(t)
                                ? new e.Frequency(t).valueOf()
                                : t instanceof e.TimeBase
                                ? t.toFrequency()
                                : void 0;
                        }),
                        (e.prototype.toTicks = function (t) {
                            return this.isNumber(t) || this.isString(t)
                                ? new e.TransportTime(t).toTicks()
                                : this.isUndef(t)
                                ? e.Transport.ticks
                                : t instanceof e.TimeBase
                                ? t.toTicks()
            ...
            void 0 ===
                (r = function (n) {
                    ...
                    return (
                        ...
                        n.extend(n.Gain),
                        (n.Gain.defaults = { gain: 1, convert: !0 }),
                        ...
                        (n.prototype.createInsOuts = function (t, e) {
                            1 === t
                                ? (this.input = new n.Gain())
                                : 1 < t && (this.input = new Array(t)),
                                1 === e
                                    ? (this.output = new n.Gain())
                                    : 1 < e && (this.output = new Array(t));
                        }),
                        n.Gain
                    );
                    ...
                    return (
                        (r.Clock = function () {
                            ...
                            (this.callback = t.callback),
                                (this._nextTick = 0),
                                (this._lastState = r.State.Stopped),
                                (this.frequency = new r.TimelineSignal(
                                    t.frequency,
                                    r.Type.Frequency,
                                )),
                                this._readOnly('frequency'),
                                (this.ticks = 0),
                                (this._state = new r.TimelineState(
                                    r.State.Stopped,
                                )),
                                (this._boundLoop = this._loop.bind(this)),
                                this.context.on('tick', this._boundLoop);
                        }),
                        r.extend(r.Clock, r.Emitter),
                        (r.Clock.defaults = {
                            callback: r.noOp,
                            frequency: 1,
                            lookAhead: 'auto',
                        ...
                        (r.Clock.prototype.stop = function (t) {
                            return (
                                ...
                                this._state.setStateAtTime(r.State.Stopped, t),
                                this
                            );
                        }),
                        ...
                        (r.Clock.prototype._loop = function () {
                            for (
                                ...
                                var e = this._state.getValueAtTime(
                                    this._nextTick,
                                );
                                ...
                                this.frequency &&
                                    ((this._nextTick +=
                                        1 /
                                        this.frequency.getValueAtTime(
                                            this._nextTick,
                                        )),
                                    e === r.State.Started &&
                                        (this.callback(i), this.ticks++));
                            }
                        }),
                        ...
                        (r.Clock.prototype.dispose = function () {
                            r.Emitter.prototype.dispose.call(this),
                ...
                (r = function (i) {
                    function t(t, e, n) {
                        if (t.input)
                            Array.isArray(t.input)
                                ? (i.prototype.isUndef(n) && (n = 0),
                                  this.connect(t.input[n]))
                                : this.connect(t.input, e, n);
                        else
                            try {
                    ...
                    return (
                        ...
                        (i.Context = function (t) {
                            for (var e in (i.Emitter.call(this),
                        ...
                        i.extend(i.Context, i.Emitter),
                        i.Emitter.mixin(i.Context),
                        (i.Context.prototype._defineProperty = function (e, n) {
                            this.isUndef(this[n]) &&
                        ...
                        (i.Context.prototype._createWorker = function () {
                            ...
                            var t = new Blob([
                                    'var timeoutTime = ' +
                                        (1e3 * this._updateInterval).toFixed(
                                            1,
                                        ) +
                                ...
                                n.addEventListener(
                                    ...
                                    function () {
                                        ...
                                        if (this.isNumber(this._lastUpdate)) {
                                            ...
                                            this._computedUpdateInterval =
                                                Math.max(
                                                    e,
                                                    0.97 *
                                                        this
                                                            ._computedUpdateInterval,
                                                );
                                        }
                                        this._lastUpdate = t;
                                    }.bind(this),
                        ...
                        i.supported &&
                            ...
                            AudioNode.prototype.connect !== t &&
                                ...
                                (AudioNode.prototype.disconnect = function (
                                    ...
                                    if (t && t.input && Array.isArray(t.input))
                                        i.prototype.isUndef(n) && (n = 0),
                                            this.disconnect(t.input[n], e, n);
                                    else if (t && t.input)
                                        this.disconnect(t.input, e, n);
                                    else
                                        try {
                                            o.apply(this, arguments);
                                        } catch (e) {
                                            throw new Error(
                                                'error disconnecting node: ' +
                                                    t +
                                                    '\n' +
                                                    e,
                                            );
                        ...
                        (e.Subtract = function (t) {
                            this.createInsOuts(2, 0),
                                (this._sum =
                                    ...
                                    this.output =
                                        new e.Gain()),
                                (this._neg = new e.Negate()),
                                (this._param = this.input[1] = new e.Signal(t)),
                                this._param.chain(this._neg, this._sum);
                        }),
                        e.extend(e.Subtract, e.Signal),
                        (e.Subtract.prototype.dispose = function () {
                            return (
                                e.prototype.dispose.call(this),
                                this._neg.dispose(),
                                (this._neg = null),
            ...
            void 0 ===
                (r = function (s) {
                    ...
                    return (
                        ...
                        s.extend(s.Emitter),
                        (s.Emitter.prototype.on = function (t, e) {
                            for (
                                var n = t.split(/\W+/), i = 0;
                                i < n.length;
                                i++
                        ...
                        (s.Emitter.prototype.off = function (t, e) {
                            for (
                                ...
                                if (
                                    ((t = n[i]), this._events.hasOwnProperty(t))
                                )
                                    if (s.prototype.isUndef(e))
                                        this._events[t] = [];
                                    else
                                        for (
                                            var r = this._events[t], o = 0;
                                            o < r.length;
                                            o++
                                        )
                                            r[o] === e && r.splice(o, 1);
        ...
        (i = [n(0)]),
            void 0 ===
                (r = function (i) {
                    'use strict';
                    return (
                        (i.SignalBase = function () {}),
                        i.extend(i.SignalBase),
                        (i.SignalBase.prototype.connect = function (t, e, n) {
                            return (
                                (i.Signal && i.Signal === t.constructor) ||
                                (i.Param && i.Param === t.constructor) ||
                                (i.TimelineSignal &&
                                    i.TimelineSignal === t.constructor)
                                    ...
                                    : t instanceof AudioParam &&
                                      ...
                                      (t.value = 0)),
                                i.prototype.connect.call(this, t, e, n),
                                this
                            );
                        }),
                        i.SignalBase
        ...
        (i = [n(0), n(17)]),
            void 0 ===
                (r = function (n) {
                    return (
                        (n.Time = function (t, e) {
                            if (!(this instanceof n.Time))
                                return new n.Time(t, e);
                            (this._plusNow = !1), n.TimeBase.call(this, t, e);
                        }),
                        n.extend(n.Time, n.TimeBase),
                        (n.Time.prototype._unaryExpressions = Object.create(
                            n.TimeBase.prototype._unaryExpressions,
                        )),
                        (n.Time.prototype._unaryExpressions.quantize = {
                            regexp: /^@/,
                            method: function (t) {
                        ...
                        (n.Time.prototype.quantize = function (t, e) {
                            return (
                                ...
                                (this._expr = function (t, e, n) {
                                    return (
                                        (t = t()),
                                        (e = e.toSeconds()),
                                        t + (Math.round(t / e) * e - t) * n
                                    );
                                }.bind(
                                    this,
                                    this._expr,
                        ...
                        (n.Time.prototype.copy = function (t) {
                            return (
                                n.TimeBase.prototype.copy.call(this, t),
                        ...
                        (n.Time.prototype.toNotation = function () {
                            ...
                            return n.split('+').length < e.split('+').length
                                ? n
                                : e;
                        }),
                        (n.Time.prototype._toNotationHelper = function (t, e) {
                            for (
                                var n = this._notationToUnits(e[e.length - 1]),
                                    i = '',
                                    r = 0;
                                r < e.length;
                                r++
                            ) {
                                var o = this._notationToUnits(e[r]),
                                    s = t / o;
                                if (
                                    (1 - (s % 1) < 1e-6 && (s += 1e-6),
                                    0 < (s = Math.floor(s)))
                        ...
                        (n.Time.prototype._notationToUnits = function (t) {
                            for (
                                var e = this._primaryExpressions,
                                    n = [e.n, e.t, e.m],
                                    i = 0;
                                i < n.length;
                                i++
                        ...
                        (n.Time.prototype.valueOf = function () {
                            return (
                                this._expr() + (this._plusNow ? this.now() : 0)
                            );
                        }),
                        n.Time
                    );
    ...
    function (t, e, n) {
        ...
        (i = [n(0)]),
            void 0 ===
                (r = function (i) {
                    return (
                        (i.TimeBase = function (t, e) {
                            if (!(this instanceof i.TimeBase))
                                return new i.TimeBase(t, e);
                            if (
                                ((this._expr = this._noOp),
                                t instanceof i.TimeBase)
                            )
                                this.copy(t);
                        ...
                        i.extend(i.TimeBase),
                        (i.TimeBase.prototype.set = function (t) {
                            return (
                                (this._expr = this._parseExprString(t)), this
                            );
                        }),
                        ...
                        (i.TimeBase.prototype._primaryExpressions = {
                            ...
                            m: {
                                ...
                                method: function (t) {
                                    return this._beatsToUnits(
                                        parseInt(t) * this._timeSignature(),
                                    );
                                },
                            },
                            i: {
                            ...
                            samples: {
                                ...
                                method: function (t) {
                                    return (
                                        parseInt(t) / this.context.sampleRate
                                    );
                                },
                            },
                            default: {
                        ...
                        (i.TimeBase.prototype._tokenize = function (t) {
                            ...
                            function r(t, e) {
                                ...
                                throw new SyntaxError(
                                    'Tone.TimeBase: Unexpected token ' + t,
                                );
                            }
                            return {
                                next: function () {
                        ...
                        (i.TimeBase.prototype._parseBinary = function (t, e) {
                            ...
                            this.isUndef(e) && (e = 2),
                                (n =
                                    e < 0
                                        ? this._parseUnary(t)
                                        : this._parseBinary(t, e - 1));
                            for (
                                var i = t.peek();
                                i &&
                                this._matchGroup(i, this._binaryExpressions, e);

                            )
                                (n = (i = t.next()).method.bind(
                                    this,
                                    n,
                                    this._parseBinary(t, e - 1),
                                )),
                        ...
                        (i.TimeBase.prototype._parseUnary = function (t) {
                            ...
                            return i
                                ? ((e = t.next()),
                                  (n = this._parseUnary(t)),
                                  i.method.bind(this, n))
                        ...
                        (i.TimeBase.prototype._parsePrimary = function (t) {
                            ...
                            throw new SyntaxError(
                                'Tone.TimeBase: Cannot process token ' +
                                    e.value,
                            );
                        }),
                        ...
                        (i.TimeBase.prototype._defaultUnits = 's'),
                        (i.TimeBase.prototype._frequencyToUnits = function (t) {
                            return 1 / t;
                        }),
                        ...
                        (i.TimeBase.prototype._ticksToUnits = function (t) {
                            return (
                                t * (this._beatsToUnits(1) / i.Transport.PPQ)
                            );
                        }),
                        ...
                        (i.TimeBase.prototype._pushExpr = function (t, e, n) {
                            return (
                                t instanceof i.TimeBase ||
                                    (t = new this.constructor(t, n)),
                                (this._expr = this._binaryExpressions[
                                    e
                                ].method.bind(this, this._expr, t._expr)),
                                this
                            );
                        }),
            ...
            void 0 ===
                (r = function (i) {
                    ...
                    return (
                        ...
                        (i.Param.prototype._minOutput = 1e-5),
                        (i.Param.prototype.setValueAtTime = function (t, e) {
                            return (
                                (t = this._fromUnits(t)),
                                (e = this.toSeconds(e)) <=
                                this.now() + this.blockTime
                                    ? (this._param.value = t)
                                    : this._param.setValueAtTime(t, e),
                                this
                            );
                        ...
                        (i.Param.prototype.linearRampToValueAtTime = function (
                            t,
                            e,
                        ) {
                            return (
                        ...
                        (i.Param.prototype.exponentialRampToValueAtTime =
                            function (t, e) {
                                return (
                                    (t = this._fromUnits(t)),
                                    (t = Math.max(this._minOutput, t)),
                        ...
                        (i.Param.prototype.exponentialRampToValue = function (
                            t,
                            e,
                            n,
                        ) {
                        ...
                        (i.Param.prototype.linearRampToValue = function (
                            t,
                            e,
                            n,
                        ) {
                        ...
                        (i.Param.prototype.setTargetAtTime = function (
                            t,
                            e,
                            n,
                        ) {
                        ...
                        (i.Param.prototype.setValueCurveAtTime = function (
                            t,
                            e,
                            n,
                        ) {
                            for (var i = 0; i < t.length; i++)
                                t[i] = this._fromUnits(t[i]);
                            return (
                        ...
                        (i.Param.prototype.cancelScheduledValues = function (
                            t,
                        ) {
                            return (
                                this._param.cancelScheduledValues(
                                    this.toSeconds(t),
                                ),
                                this
                            );
                        ...
                        (i.Param.prototype.rampTo = function (t, e, n) {
                            return (
                                (e = this.defaultArg(e, 0)),
                                this.units === i.Type.Frequency ||
                                this.units === i.Type.BPM ||
                                this.units === i.Type.Decibels
                                    ? this.exponentialRampToValue(t, e, n)
                                    : this.linearRampToValue(t, e, n),
                                this
                            );
                        }),
                        ...
                        (i.Param.prototype.dispose = function () {
                            return (
                                ...
                                (this._param = null),
                                this._lfo &&
                                    (this._lfo.dispose(), (this._lfo = null)),
                                this
                            );
                        }),
                        i.Param
            ...
            void 0 ===
                (r = function (e) {
                    ...
                    return (
                        ...
                        e.extend(e.Timeline),
                        (e.Timeline.defaults = { memory: 1 / 0 }),
                        ...
                        (e.Timeline.prototype.getAfter = function (t) {
                            var e = this._search(t);
                            return e + 1 < this._timeline.length
                                ? this._timeline[e + 1]
                                : null;
                        }),
                        ...
                        (e.Timeline.prototype._search = function (t) {
                            var e = 0,
                                ...
                                i = n;
                            if (0 < n && this._timeline[n - 1].time <= t)
                                return n - 1;
                            for (; e < i; ) {
                                var r = Math.floor(e + (i - e) / 2),
                                    o = this._timeline[r],
                                    s = this._timeline[r + 1];
                                if (o.time === t) {
                                    for (
                                        var a = r;
                                        a < this._timeline.length;
                                        a++
                                    )
                                        this._timeline[a].time === t && (r = a);
                                    return r;
                                }
                        ...
                        (e.Timeline.prototype._iterate = function (t, e, n) {
                            ...
                            if (
                                ((this._iterating = !1),
                                0 < this._toRemove.length)
                            ) {
                                for (
                                    var r = 0;
                                    r < this._toRemove.length;
                                    r++
                                ) {
                                    var o = this._timeline.indexOf(
                                        this._toRemove[r],
                                    );
                            ...
                            function (e, t, n) {
                                ...
                                return (
                                    (function t(e, n, i) {
                                        if (
                                            Array.isArray(e) ||
                                            (NodeList && e instanceof NodeList)
                                        )
    ...
    function (t, e, n) {
        var i, r;
        (i = [n(0), n(2), n(32), n(38), n(10)]),
            void 0 ===
                (r = function (e) {
                    'use strict';
                    return (
                        (e.CrossFade = function (t) {
                            this.createInsOuts(2, 1),
                                (this.a = this.input[0] = new e.Gain()),
                                (this.b = this.input[1] = new e.Gain()),
                                (this.fade = new e.Signal(
                                    this.defaultArg(t, 0.5),
                                    e.Type.NormalRange,
                                )),
                                (this._equalPowerA = new e.EqualPowerGain()),
                                (this._equalPowerB = new e.EqualPowerGain()),
                                (this._invert = new e.Expr('1 - $0')),
                        ...
                        e.extend(e.CrossFade),
                        (e.CrossFade.prototype.dispose = function () {
                            return (
                                e.prototype.dispose.call(this),
                                this._writable('fade'),
    ...
    function (t, e) {
        ...
        (a = []),
            'function' != typeof AudioWorkletNode &&
                ((self.AudioWorkletNode = function (t, e, n) {
                    var i = h(t)[e],
                        r = t.createScriptProcessor(
                            void 0,
                            2,
                            n && n.outputChannelCount
                                ? n.outputChannelCount[0]
                                : 2,
                        );
                    if (((r.parameters = new Map()), i.properties))
                        for (var o = 0; o < i.properties.length; o++) {
                            var s = i.properties[o],
                                a = t.createGain().gain;
                            (a.value = s.defaultValue),
                                r.parameters.set(s.name, a);
                        }
                ...
                Object.defineProperty(
                    ...
                    'audioWorklet',
                    {
                        get: function () {
                            return (
                                this.$$audioWorklet ||
                                (this.$$audioWorklet = new self.AudioWorklet(
                                    this,
                                ))
                            );
                        },
                ...
                (self.AudioWorklet =
                    ((n.prototype.addModule = function (t, e) {
                        var r = this;
                        return fetch(t)
                            .then(function (t) {
                                ...
                                var n = {
                                    ...
                                    i = new (function (t, e) {
                                        ...
                                        u.appendChild(
                                            ...
                                            (this.exec = i.$hook(t, console));
                                    })((n.self = n), document.documentElement);
                                return (
                                    i.exec(((e && e.transpile) || String)(t)),
                                    null
                                );
                            });
                    }),
    ...
    function (t, e) {
        function n(t) {
            t &&
                (t.setTargetAtTime ||
                    (t.setTargetAtTime = t.setTargetValueAtTime));
        }
        window,
            window.hasOwnProperty('webkitAudioContext') &&
                !window.hasOwnProperty('AudioContext') &&
                ...
                'function' !=
                    typeof AudioContext.prototype.createScriptProcessor &&
                    (AudioContext.prototype.createScriptProcessor =
                        AudioContext.prototype.createJavaScriptNode),
                'function' !=
                    typeof AudioContext.prototype.createPeriodicWave &&
                ...
                (AudioContext.prototype.createBufferSource = function () {
                    ...
                    return (
                        i.start
                            ? ((i.internal_start = i.start),
                              (i.start = function (t, e, n) {
                                  void 0 !== n
                                      ? i.internal_start(t || 0, e, n)
                                      : i.internal_start(t || 0, e || 0);
                              }))
                            : (i.start = function (t, e, n) {
                                  e || n
                                      ? this.noteGrainOn(t || 0, e, n)
                                      : this.noteOn(t || 0);
                              }),
                        i.stop
                            ? ((i.internal_stop = i.stop),
                              (i.stop = function (t) {
                                  i.internal_stop(t || 0);
                              }))
                            : (i.stop = function (t) {
        ...
        p5.prototype.isFileSupported = function (t) {
            switch (t.toLowerCase()) {
                ...
                case 'ogg':
                    return (
                        !!i.canPlayType &&
                        i.canPlayType('audio/ogg; codecs="vorbis"')
                    );
                case 'aac':
                case 'm4a':
                case 'mp4':
            ...
            void 0 ===
                (r = function (r) {
                    (r.Frequency = function (t, e) {
                        if (!(this instanceof r.Frequency))
                            return new r.Frequency(t, e);
                        r.TimeBase.call(this, t, e);
                    }),
                        r.extend(r.Frequency, r.TimeBase),
                        (r.Frequency.prototype._primaryExpressions =
                            Object.create(
                                r.TimeBase.prototype._primaryExpressions,
                            )),
                        (r.Frequency.prototype._primaryExpressions.midi = {
                            regexp: /^(\d+(?:\.\d+)?midi)/,
                            method: function (t) {
                        ...
                        (r.Frequency.prototype._primaryExpressions.note = {
                            ...
                            method: function (t, e) {
                                var n =
                                    i[t.toLowerCase()] + 12 * (parseInt(e) + 1);
                        ...
                        (r.Frequency.prototype.transpose = function (t) {
                            return (
                                (this._expr = function (t, e) {
                                    return (
                                        t() * this.intervalToFrequencyRatio(e)
                                    );
                            ...
                            return (
                                (this._expr = function (t, e) {
                                    for (
                                        ...
                                        i[r] =
                                            n *
                                            this.intervalToFrequencyRatio(e[r]);
                                    return i;
                                }.bind(this, this._expr, t)),
                                this
                            );
                        ...
                        (r.Frequency.prototype.toNote = function () {
                            var t = this.valueOf(),
                                e = Math.log(t / r.Frequency.A4) / Math.LN2,
                        ...
                        (r.Frequency.prototype._frequencyToUnits = function (
                            t,
                        ) {
                            return t;
                        }),
                        (r.Frequency.prototype._ticksToUnits = function (t) {
                            return (
                                1 /
                                ((60 * t) /
                                    (r.Transport.bpm.value * r.Transport.PPQ))
                            );
                        }),
                        (r.Frequency.prototype._beatsToUnits = function (t) {
                            return (
                                1 /
                                r.TimeBase.prototype._beatsToUnits.call(this, t)
                            );
                        }),
    ...
    function (t, e, n) {
        ...
        (i = [n(0), n(16)]),
            void 0 ===
                (r = function (i) {
                    return (
                        (i.TransportTime = function (t, e) {
                            if (!(this instanceof i.TransportTime))
                                return new i.TransportTime(t, e);
                            i.Time.call(this, t, e);
                        }),
                        i.extend(i.TransportTime, i.Time),
                        (i.TransportTime.prototype._unaryExpressions =
                            Object.create(i.Time.prototype._unaryExpressions)),
                        (i.TransportTime.prototype._unaryExpressions.quantize =
                            {
                                regexp: /^@/,
                                method: function (t) {
                        ...
                        (i.TransportTime.prototype._secondsToTicks = function (
                            t,
                        ) {
                        ...
                        (i.TransportTime.prototype.valueOf = function () {
                            return (
                                ...
                                (this._plusNow ? i.Transport.ticks : 0)
                            );
                        }),
                        ...
                        (i.TransportTime.prototype.toSeconds = function () {
                            return (
                                this._expr() +
                                (this._plusNow ? i.Transport.seconds : 0)
                            );
                        }),
            ...
            void 0 ===
                (r = function (u) {
                    ...
                    function n(t, e, n) {
                        var i = new t();
                        return (
                            n._eval(e[0]).connect(i, 0, 0),
                            n._eval(e[1]).connect(i, 0, 1),
                            i
                        );
                    }
                    function i(t, e, n) {
                    ...
                    return (
                        (u.Expr = function () {
                            ...
                            try {
                                ...
                                throw (
                                    (this._disposeNodes(),
                                    new Error(
                                        'Tone.Expr: Could evaluate expression: ' +
                                            t,
                                    ))
                                );
                            }
                        ...
                        (u.Expr.prototype._replacements = function (t) {
                            for (var e = t.shift(), n = 0; n < t.length; n++)
                                e = e.replace(/\%/i, t[n]);
                            return e;
                        }),
                                            ...
                                            ? (function t() {
                                                  ...
                                                  return o(
                                                      ...
                                                      : (function () {
                                                            ...
                                                            throw new SyntaxError(
                                                                'Tone.Expr: Parse error, cannot process token ' +
                                                                    t.value,
                                                            );
                                                        })();
                                              })()
                                            : a(t - 1));
                                for (var n = i.peek(); o(n, 'binary', t); )
                                    (e = {
                ...
                (r = function (e) {
                    ...
                    return (
                        (e.GreaterThan = function (t) {
                            this.createInsOuts(2, 0),
                                (this._param = this.input[0] =
                                    new e.Subtract(t)),
                                (this.input[1] = this._param.input[1]),
                                (this._gtz = this.output =
                                    new e.GreaterThanZero()),
                    ...
                    return (
                        (e.Modulo = function (t) {
                            this.createInsOuts(1, 0),
                                (this._shaper = new e.WaveShaper(
                                    Math.pow(2, 16),
                                )),
                                (this._multiply = new e.Multiply()),
                                (this._subtract = this.output =
                                    new e.Subtract()),
                                (this._modSignal = new e.Signal(t)),
                        ...
                        e.extend(e.Modulo, e.SignalBase),
                        (e.Modulo.prototype._setWaveShaper = function (e) {
            ...
            void 0 ===
                (r = function (e) {
                    ...
                    return (
                        ...
                        e.extend(e.Pow, e.SignalBase),
                        Object.defineProperty(e.Pow.prototype, 'value', {
                            get: function () {
                                return this._exp;
                            },
                            set: function (t) {
                                (this._exp = t),
                                    this._expScaler.setMap(
                                        this._expFunc(this._exp),
                                    );
                            },
                        }),
        ...
        (i = [n(0), n(19), n(9)]),
            void 0 ===
                (r = function (e) {
                    'use strict';
                    return (
                        (e.TimelineState = function (t) {
                            e.Timeline.call(this), (this._initial = t);
                        }),
                        e.extend(e.TimelineState, e.Timeline),
                        (e.TimelineState.prototype.getValueAtTime = function (
                            t,
                        ) {
                            var e = this.get(t);
                            return null !== e ? e.state : this._initial;
                        }),
                        (e.TimelineState.prototype.setStateAtTime = function (
                            t,
                            e,
                        ) {
    ...
    function (t, e, n) {
        ...
        var o = new (function t() {
            !(function (t, e) {
                ...
                (this.input = c.a.createGain()),
                (this.output = c.a.createGain()),
                (this.limiter = c.a.createDynamicsCompressor()),
                (this.limiter.threshold.value = -3),
                (this.limiter.ratio.value = 20),
                (this.limiter.knee.value = 1),
                (this.audiocontext = c.a),
                this.output.disconnect(),
                this.input.connect(this.limiter),
                this.limiter.connect(this.output),
                (this.meter = c.a.createGain()),
                (this.fftMeter = c.a.createGain()),
                ...
                var e =
                    ...
                    n =
                        2 < arguments.length && void 0 !== arguments[2]
                            ...
                            : 0;
                if ('number' == typeof t) {
                    var i = o.audiocontext.currentTime,
                        r = o.output.gain.value;
                    o.output.gain.cancelScheduledValues(i + n),
                        o.output.gain.linearRampToValueAtTime(r, i + n),
                        o.output.gain.linearRampToValueAtTime(t, i + n + e);
                } else {
                    if (!t) return o.output.gain;
                    t.connect(o.output.gain);
                }
            }),
            (p5.prototype.soundOut = p5.soundOut = o),
            (p5.soundOut._silentNode = o.audiocontext.createGain()),
            (p5.soundOut._silentNode.gain.value = 0),
            p5.soundOut._silentNode.connect(o.audiocontext.destination);
        var p = o,
            i = n(5),
            s = n.n(i);
        function f(t) {
        ...
        function a(t) {
            var e,
                n = u(
                    ...
                    1 < t.numberOfChannels ? t.getChannelData(1) : e,
                ),
                i = new window.ArrayBuffer(44 + 2 * n.length),
                r = new window.DataView(i);
            d(r, 0, 'RIFF'),
                r.setUint32(4, 36 + 2 * n.length, !0),
                d(r, 8, 'WAVE'),
                d(r, 12, 'fmt '),
                r.setUint32(16, 16, !0),
                r.setUint16(20, 1, !0),
                r.setUint16(22, 2, !0),
                r.setUint32(24, p.audiocontext.sampleRate, !0),
                r.setUint32(28, 4 * p.audiocontext.sampleRate, !0),
                r.setUint16(32, 4, !0),
                r.setUint16(34, 16, !0),
                d(r, 36, 'data'),
                r.setUint32(40, 2 * n.length, !0);
            for (var o = n.length, s = 44, a = 0; a < o; a++)
                r.setInt16(s, 32767 * n[a], !0), (s += 2);
            return r;
        }
        function u(t, e) {
            for (
        ...
        function y(t) {
            var e = t,
                n = new AudioWorkletNode(
                    p.audiocontext,
                    s.a.soundFileProcessor,
                );
            return (
                n instanceof ScriptProcessorNode && (e = n.bufferSize),
                n.disconnect(),
                (n = null),
                e
            );
        ...
        var m = function (t, e, n) {
            ...
            v = [n(27).default, n(28).default, n(29).default],
            _ = p.audiocontext,
            g = !1;
        function b(t, e) {
            if (!(t instanceof e))
        ...
        var x,
            S = p.audiocontext;
        void 0 !== S.createStereoPanner
            ? (x = (function () {
                  function n(t, e) {
                      b(this, n),
                          (this.stereoPanner = this.input =
            ...
            : (x = (function () {
                  function i(t, e, n) {
                      b(this, i),
                          (this.input = S.createGain()),
                          t.connect(this.input),
                          (this.left = S.createGain()),
                          (this.right = S.createGain()),
                          (this.left.channelInterpretation = 'discrete'),
                          (this.right.channelInterpretation = 'discrete'),
                          1 < n
                              ? ((this.splitter = S.createChannelSplitter(2)),
                                this.input.connect(this.splitter),
                                this.splitter.connect(this.left, 1),
                                this.splitter.connect(this.right, 0))
                              : (this.input.connect(this.left),
                                this.input.connect(this.right)),
                          (this.output = S.createChannelMerger(2)),
                      ...
                      w(i, [
                          {
                              ...
                              value: function (t, e) {
                                  var n = e || 0,
                                      ...
                                      s = Math.sin((r * Math.PI) / 2);
                                  this.left.gain.linearRampToValueAtTime(s, i),
                                      this.right.gain.linearRampToValueAtTime(
                                          o,
                                          i,
                                      );
                              },
                              ...
                              value: function (t) {
                                  1 === t
                                      ? (this.input.disconnect(),
                                        ...
                                        this.input.connect(this.right))
                                      : 2 === t &&
                                        (void 0 === this.splitter &&
                                            (this.splitter =
                                                S.createChannelSplitter(2)),
                                        this.input.disconnect(),
                                        this.input.connect(this.splitter),
                                        this.splitter.connect(this.left, 1),
                                        this.splitter.connect(this.right, 0));
        ...
        var q = (function () {
            function o(t, e, n, i) {
                ...
                (this._onended = function () {}),
                    ...
                    (this.panPosition = 0),
                    (this.panner = new k(this.output, p.input, 2)),
                    (this.url || this.file) && this.load(e, n),
                    p.soundArray.push(this),
                    (this._whileLoading =
                        'function' == typeof i ? i : function () {}),
                    (this._clearOnEnd = function (t) {
                        var e = t.target,
                            n = this;
                        (e._playing = !1),
                            e.removeEventListener('ended', n._clearOnEnd),
                            n._onended(n),
                            n.bufferSourceNodes
                                .map(function (t, e) {
                                    return e;
                                ...
                                .reverse()
                                .forEach(function (t) {
                                    !1 === n.bufferSourceNodes[t]._playing &&
                                        n.bufferSourceNodes.splice(t, 1);
                                }),
                            0 === n.bufferSourceNodes.length &&
                                (n._playing = !1);
                    }.bind(this)),
                ...
                (function (t, e, n) {
                                                ...
                                                function () {
                                                    if (r.panner) {
                                                        var t = new m(
                                                            ...
                                                            e =
                                                                'AudioContext error at decodeAudioData for ' +
                                                                r.url;
                                                        i &&
                                                            ((t.msg = e), i(t));
                                                    }
                    ...
                    },
                    {
                        ...
                        value: function (t, e, n, i, r) {
                            if (this.output) {
                                ...
                                if (
                                    (a < 0 && (a = 0),
                                    (a += p.audiocontext.currentTime),
                                    void 0 !== e && this.rate(e),
                                    void 0 !== n && this.setVolume(n),
                                    !this.buffer)
                                )
                                ...
                                if (
                                    ...
                                    'restart' === this.mode &&
                                        ...
                                        (this.bufferSourceNode.stop(a),
                                        this._counterNode.stop(a)),
                                    'untildone' !== this.mode ||
                                        !this.isPlaying())
                                ) {
                                    if (
                                    ...
                                    (r =
                                        ...
                                        this._paused
                                            ...
                                            : (this.bufferSourceNode.start(
                                              ...
                                              this._counterNode.start(a, o, r)),
                                        (this._playing = !0),
                                        (this._paused = !1),
                                        this.bufferSourceNodes.push(
                                            this.bufferSourceNode,
                                        ),
                                        (this.bufferSourceNode._arrayIndex =
                                            this.bufferSourceNodes.length - 1),
                                        this.bufferSourceNode.addEventListener(
                                            'ended',
                                            this._clearOnEnd,
                                        ),
                                        (this.bufferSourceNode.loop =
                                            this._looping),
                                        (this._counterNode.loop =
                                            this._looping),
                                        !0 === this._looping &&
                                            ((s = r || o - 1e-15),
                                            (this.bufferSourceNode.loopStart =
                                                o),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (
                                ...
                                for (
                                    var n = 0;
                                    n < this.bufferSourceNodes.length - 1;
                                    n++
                                ) {
                        ...
                        value: function (t) {
                            ...
                            this.bufferSourceNode
                                ? ((this._paused = !0),
                                  ...
                                  this.bufferSourceNode.stop(e),
                                  this._counterNode.stop(e),
                        ...
                        value: function (t) {
                            ...
                            if (
                                ...
                                var n = p.audiocontext.currentTime,
                                    i = e || 0;
                                (this.pauseTime = 0),
                                    this.bufferSourceNode.stop(n + i),
                                    this._counterNode.stop(n + i),
                                    (this._playing = !1),
                                    (this._paused = !1);
                            }
                        },
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (
                                (0 === (this.playbackRate = t)
                                    ? (t = 1e-13)
                                    : t < 0 && !this.reversed
                                    ? ((t = Math.abs(t)), (e = !0))
                                    : 0 < t && this.reversed && (e = !0),
                                this.bufferSourceNode)
                            ) {
                                var n = p.audiocontext.currentTime;
                                this.bufferSourceNode.playbackRate.cancelScheduledValues(
                                    n,
                                ),
                                    ...
                                    this._counterNode.playbackRate.cancelScheduledValues(
                                        n,
                                    ),
                    ...
                    },
                    {
                        ...
                        value: function (t, e, n) {
                            if ('number' == typeof t) {
                                var i = e || 0,
                                    r = n || 0,
                                    o = p.audiocontext.currentTime,
                                    s = this.output.gain.value;
                                this.output.gain.cancelScheduledValues(o + r),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return this.reversed
                                ? Math.abs(this._lastPos - this.buffer.length) /
                                      R.sampleRate
                            ...
                            if (((t = t || 5 * window.width), this.buffer)) {
                                for (
                                    var e = this.buffer,
                                        ...
                                        o = new Float32Array(Math.round(t)),
                                        s = 0;
                                    s < r;
                                    s++
                                )
                                    for (
                                        var a = e.getChannelData(s), u = 0;
                                        u < t;
                                        u++
                                    ) {
                                        for (
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            var t = this._lastPos / R.sampleRate,
                                e = this.getVolume();
                            this.setVolume(0, 0.001);
                            for (
                                var n = this.buffer.numberOfChannels, i = 0;
                                i < n;
                                i++
                            )
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            t[0] instanceof Float32Array ||
                                (t[0] = new Float32Array(t[0]));
                            for (var r = 0; r < e; r++) {
                                i.getChannelData(r).set(t[r]);
                            }
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            return (
                                n._workletNode &&
                                    (n._workletNode.disconnect(),
                                    delete n._workletNode),
                                (n._workletNode = new AudioWorkletNode(
                                    R,
                                    s.a.soundFileProcessor,
                                ...
                                (n._workletNode.port.onmessage = function (t) {
                                    if ('position' === t.data.name) {
                                        ...
                                        (e._lastPos = t.data.position),
                                            e._onTimeUpdate(n._lastPos);
                                    }
                                }),
                                (i.buffer = (function (t) {
                                    for (
                                ...
                                i.playbackRate.setValueAtTime(
                                    n.playbackRate,
                                    t,
                                ),
                                i.connect(n._workletNode),
                                n._workletNode.connect(p5.soundOut._silentNode),
                                i
                            );
                        },
                    },
                    ...
                    { key: 'processPeaks', value: function (t, e, n, i) {} },
                    {
                        key: 'addCue',
                        value: function (t, e, n) {
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            for (
                                var e = t / this.buffer.sampleRate,
                                    n = this._cues.length,
                                    i = 0;
                                i < n;
                                i++
        ...
        var B = (function () {
            function e(t) {
                !(function (t, e) {
                    ...
                    (this.bufferSize = y(2048)),
                    (this.audiocontext = p.audiocontext),
                    (this._workletNode = new AudioWorkletNode(
                        this.audiocontext,
                        s.a.amplitudeProcessor,
                        {
                            outputChannelCount: [1],
                            parameterData: { smoothing: t || 0 },
                            processorOptions: {
                                normalize: !1,
                                smoothing: t || 0,
                                numInputChannels: 2,
                    ...
                    (this._workletNode.port.onmessage = function (t) {
                        'amplitude' === t.data.name &&
                            ((this.volume = t.data.volume),
                            (this.volNorm = t.data.volNorm),
                            (this.stereoVol = t.data.stereoVol),
                            (this.stereoVolNorm = t.data.stereoVolNorm));
                    }.bind(this)),
                    ...
                    this.output.connect(this.audiocontext.destination),
                    p.meter.connect(this._workletNode),
                    p.soundArray.push(this);
            }
            return (
                (function (t, e, n) {
                ...
                })(e, [
                    {
                        ...
                        value: function (t, e) {
                            p.meter.disconnect(),
                                e &&
                                    (this._workletNode.parameters.get(
                                        'smoothing',
                                    ).value = e),
                                null == t
                                    ? p.meter.connect(this._workletNode)
                                    : t
                                    ? (t.connect(this._workletNode),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            (this.normalize =
                                'boolean' == typeof t ? t : !this.normalize),
        ...
        var j = (function () {
                function n(t, e) {
                    !(function (t, e) {
                        ...
                        this.smooth(t),
                        (this.bins = e || 1024),
                        p.fftMeter.connect(this.analyser),
                ...
                return (
                    (function (t, e, n) {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if (e && !p5.prototype._isSafari())
                                    return (
                                        (function (t) {
                                            t.timeDomain instanceof
                                                Float32Array ==
                                                !1 &&
                                                (t.timeDomain =
                                                    new Float32Array(
                                                        t.analyser.frequencyBinCount,
                                                    ));
                                        })(this, this.timeDomain),
                                ...
                                for (
                                    var r = 0;
                                    r < this.timeDomain.length;
                                    r++
                                ) {
                                    var o = p5.prototype.map(
                                        this.timeDomain[r],
                                        0,
                                        255,
                                        -1,
                                ...
                                for (var t, e = 0; e < arguments.length; e++)
                                    'number' == typeof arguments[e] &&
                                        ...
                                        'string' == typeof arguments[e] &&
                                            (t = arguments[e]);
                                return t && 'db' === t.toLowerCase()
                                    ? ((function (t) {
                                          t.freqDomain instanceof
                                              Float32Array ==
                                              !1 &&
                                              (t.freqDomain = new Float32Array(
                                                  t.analyser.frequencyBinCount,
                                              ));
                                      })(this),
                                      ...
                                      this.freqDomain)
                                    : ((function (t) {
                                          t.freqDomain instanceof Uint8Array ==
                                              !1 &&
                                              (t.freqDomain = new Uint8Array(
                                                  t.analyser.frequencyBinCount,
                                              ));
                                      })(this, this.freqDomain),
                                      this.analyser.getByteFrequencyData(
                                          this.freqDomain,
                                      ),
                                      Array.apply([], this.freqDomain));
                            },
                        },
                        {
                            key: 'getEnergy',
                                ...
                                if (e) {
                                    if (t && e) {
                                        ...
                                        for (
                                            ...
                                            (s += this.freqDomain[u]), (a += 1);
                                        return s / a;
                                    }
                                    throw 'invalid input for getEnergy()';
                                }
                                var c = Math.round(
                                    (t / n) * this.freqDomain.length,
                                );
                        ...
                        },
                        {
                            ...
                            value: function () {
                                for (
                                    var t = p.audiocontext.sampleRate / 2,
                                        e = 0,
                                        n = 0,
                                        i = 0;
                                    i < this.freqDomain.length;
                                    i++
                                )
                                    (e += i * this.freqDomain[i]),
                                        (n += this.freqDomain[i]);
                                var r = 0;
                                return (
                                    0 !== n && (r = e / n),
                                    r * (t / this.freqDomain.length)
                                );
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                for (
                                    var e = p.audiocontext.sampleRate / 2,
                                        n = this.freqDomain,
                                        i = n.length,
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                r.push(o);
                                for (
                                    var s = p.audiocontext.sampleRate / 2;
                                    o.hi < s;

                                ) {
                                    var a = {};
                                    (a.lo = o.hi),
                                        (a.ctr = o.ctr * Math.pow(2, 1 / n)),
                                        (a.hi =
                                            a.ctr * Math.pow(2, 1 / (2 * n))),
                                        r.push(a),
                                        (o = a);
                                }
                                return r;
        ...
        function $(t, e, n, i, r) {
            ...
            for (var s in t.mathOps)
                t.mathOps[s] instanceof r &&
                    (o.disconnect(),
                    t.mathOps[s].dispose(),
                    (n = s) < t.mathOps.length - 2 && (i = t.mathOps[s + 1]));
            return (
                n === t.mathOps.length - 1 && t.mathOps.push(i),
                0 < s && (o = t.mathOps[s - 1]),
                o.disconnect(),
                o.connect(e),
                e.connect(i),
        ...
        var Q = (function () {
                function r(t, e) {
                    ...
                    (this.started = !1),
                        ...
                        (this.oscillator = p.audiocontext.createOscillator()),
                        (this.f = t || 440),
                        (this.oscillator.type = e || 'sine'),
                        ...
                        (this.panPosition = 0),
                        (this.connection = p.input),
                        (this.panner = new k(this.output, this.connection, 1)),
                    ...
                    (function (t, e, n) {
                    ...
                    })(r, [
                        {
                            ...
                            value: function (t, e) {
                                ...
                                if (!this.started) {
                                    ...
                                    for (var o in (this.oscillator &&
                                        (this.oscillator.disconnect(),
                                        delete this.oscillator),
                                    (this.oscillator =
                                        p.audiocontext.createOscillator()),
                                    ...
                                    this.oscillator.start(
                                        t + p.audiocontext.currentTime,
                                    ),
                                    (this.freqNode = this.oscillator.frequency),
                                    this._freqMods))
                                        void 0 !== this._freqMods[o].connect &&
                                            this._freqMods[o].connect(
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t = p.soundArray.indexOf(this);
                                if (
                                    (p.soundArray.splice(t, 1), this.oscillator)
                                ) {
                                    var e = p.audiocontext.currentTime;
                                    this.stop(e),
                                        this.disconnect(),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                (this.phaseAmount = t),
                                    this.dNode ||
                                        ((this.dNode =
                                            p.audiocontext.createDelay()),
                                        this.oscillator.disconnect(),
                                        this.oscillator.connect(this.dNode),
                                        this.dNode.connect(this.output)),
                                    this.dNode.delayTime.setValueAtTime(e, n);
                            },
                        },
                        {
                            key: 'add',
                        ...
                        },
                        {
                            ...
                            value: function (t, e, n, i) {
                                ...
                                o =
                                    4 === arguments.length
                                        ? ((r =
                                              p5.prototype.map(n, t, e, 0, 1) -
                                              0.5),
                                          p5.prototype.map(i, t, e, 0, 1) - 0.5)
                                        : ((r = t), e);
                                var s = new G.a(r, o);
                                return $(
                                    this,
        ...
        (p5.Envelope = function (t, e, n, i, r, o) {
            ...
            (p5.Envelope.prototype._init = function () {
                var t = p.audiocontext.currentTime;
                this.control.setTargetAtTime(1e-5, t, 0.001),
            ...
            (p5.Envelope.prototype.setADSR = function (t, e, n, i) {
                (this.aTime = t),
                    ...
                    (this.dLevel =
                        void 0 !== n
                            ? n * (this.aLevel - this.rLevel) + this.rLevel
                            : 0),
                    (this.rTime = i || 0),
                    this._setRampAD(t, e);
            }),
            ...
            (p5.Envelope.prototype._setRampAD = function (t, e) {
                ...
                var n = 1;
                (n = Math.log(
                    1 / this.checkExpInput(1 - this._rampHighPercentage),
                )),
                    (this._rampAttackTC = t / this.checkExpInput(n)),
                    (n = Math.log(1 / this._rampLowPercentage)),
                    (this._rampDecayTC = e / this.checkExpInput(n));
            }),
            (p5.Envelope.prototype.setRampPercentages = function (t, e) {
                ...
                (n = Math.log(
                    ...
                    (this._rampAttackTC =
                        this._rampAttackTime / this.checkExpInput(n)),
                    (n = Math.log(1 / this._rampLowPercentage)),
                    (this._rampDecayTC =
                        this._rampDecayTime / this.checkExpInput(n));
            }),
            ...
            (p5.Envelope.prototype.play = function (t, e, n) {
                ...
                t && this.connection !== t && this.connect(t),
                    this.triggerAttack(t, i),
                    this.triggerRelease(t, i + this.aTime + this.dTime + ~~n);
            }),
            (p5.Envelope.prototype.triggerAttack = function (t, e) {
                ...
                !0 === this.isExponential
                    ? this.control.exponentialRampToValueAtTime(
                          this.checkExpInput(i),
                          n,
                      )
                    : this.control.linearRampToValueAtTime(i, n),
                    (n += this.aTime),
                    !0 === this.isExponential
                        ? (this.control.exponentialRampToValueAtTime(
                          ...
                          (i = this.checkExpInput(
                              this.control.getValueAtTime(n),
                          )),
                          this.control.cancelScheduledValues(n),
                          this.control.exponentialRampToValueAtTime(i, n))
                        : (this.control.linearRampToValueAtTime(this.aLevel, n),
                          (i = this.control.getValueAtTime(n)),
                          this.control.cancelScheduledValues(n),
                          this.control.linearRampToValueAtTime(i, n)),
                    (n += this.dTime),
                    !0 === this.isExponential
                        ? (this.control.exponentialRampToValueAtTime(
                          ...
                          this.control.cancelScheduledValues(n),
                          this.control.exponentialRampToValueAtTime(i, n))
                        : (this.control.linearRampToValueAtTime(this.dLevel, n),
                          (i = this.control.getValueAtTime(n)),
                          this.control.cancelScheduledValues(n),
                          this.control.linearRampToValueAtTime(i, n));
            }),
            ...
            (p5.Envelope.prototype.ramp = function (t, e, n, i) {
                var r = p.audiocontext.currentTime + (e || 0),
                    o = this.checkExpInput(n),
                    s = void 0 !== i ? this.checkExpInput(i) : void 0;
                t && this.connection !== t && this.connect(t);
                var a = this.checkExpInput(this.control.getValueAtTime(r));
                a < o
                    ? (this.control.setTargetAtTime(o, r, this._rampAttackTC),
                      (r += this._rampAttackTime))
                    : o < a &&
                      (this.control.setTargetAtTime(o, r, this._rampDecayTC),
                      (r += this._rampDecayTime)),
                    void 0 !== s &&
                        (o < s
                            ? this.control.setTargetAtTime(
                                  s,
                                  r,
                                  this._rampAttackTC,
                              )
            ...
            (p5.Envelope.prototype.connect = function (t) {
                ((this.connection = t) instanceof p5.Oscillator ||
                    t instanceof p5.SoundFile ||
                    t instanceof p5.AudioIn ||
                    t instanceof p5.Reverb ||
                    t instanceof p5.Noise ||
                    t instanceof p5.Filter ||
                    t instanceof p5.Delay) &&
                    (t = t.output.gain),
                    t instanceof AudioParam &&
                        t.setValueAtTime(0, p.audiocontext.currentTime),
                    this.output.connect(t);
            }),
            ...
            (p5.Envelope.prototype.dispose = function () {
                ...
                for (var e = 1; e < this.mathOps.length; e++)
                    this.mathOps[e].dispose();
            }),
        ...
        var ht = (function () {
                for (
                    var t = 2 * p.audiocontext.sampleRate,
                        e = p.audiocontext.createBuffer(
                            1,
                            t,
                            p.audiocontext.sampleRate,
                        ),
                        n = e.getChannelData(0),
                        i = 0;
                    i < t;
            ...
            pt = (function () {
                var t,
                    ...
                    o,
                    s,
                    a = 2 * p.audiocontext.sampleRate,
                    u = p.audiocontext.createBuffer(
                        1,
                        a,
                        p.audiocontext.sampleRate,
                    ),
                    c = u.getChannelData(0);
                t = e = n = i = r = o = s = 0;
                for (var l = 0; l < a; l++) {
                    var h = 2 * Math.random() - 1;
                    (t = 0.99886 * t + 0.0555179 * h),
                        (e = 0.99332 * e + 0.0750759 * h),
                        (n = 0.969 * n + 0.153852 * h),
                        (i = 0.8665 * i + 0.3104856 * h),
                        (r = 0.55 * r + 0.5329522 * h),
                        (o = -0.7616 * o - 0.016898 * h),
                        (c[l] = t + e + n + i + r + o + s + 0.5362 * h),
                        (c[l] *= 0.11),
                        (s = 0.115926 * h);
                }
            ...
            ft = (function () {
                for (
                    ...
                    (n[r] = (i + 0.02 * o) / 1.02), (i = n[r]), (n[r] *= 3.5);
                }
            ...
            dt = (function () {
                function i(t) {
                    ...
                    return (
                        ...
                        delete (e = ut(this, ct(i).call(this))).f,
                        delete e.freq,
                        delete e.oscillator,
                        (n = 'brown' === t ? ft : 'pink' === t ? pt : ht),
                        (e.buffer = n),
                        e
                    );
                }
                    ...
                    (function (t, e, n) {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                this.started && this.stop(),
                                    (this.noise =
                                        p.audiocontext.createBufferSource()),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t = p.audiocontext.currentTime;
                                this.noise &&
                                    (this.noise.stop(t), (this.started = !1));
                            },
                        },
                        {
                            key: 'dispose',
                            value: function () {
                                ...
                                p.soundArray.splice(e, 1),
                                    this.noise &&
                                        (this.noise.disconnect(), this.stop(t)),
                                    this.output && this.output.disconnect(),
                                    this.panner && this.panner.disconnect(),
                                    (this.output = null),
                                    (this.panner = null),
        ...
        var xt = (function () {
            function r(t, e) {
                ...
                !(function (t, e) {
                    ...
                    ((n = gt(this, bt(r).call(this, t, 'sawtooth'))).w =
                        e || 0),
                    (n.osc2 = new tt(t)),
                    (n.dNode = p.audiocontext.createDelay()),
                    (n.dcOffset = wt()),
                    (n.dcGain = p.audiocontext.createGain()),
                    n.dcOffset.connect(n.dcGain),
                    n.dcGain.connect(n.output),
                    (n.f = t || 440);
                var i = n.w / n.oscillator.frequency.value;
                return (
                    (n.dNode.delayTime.value = i),
                    (n.dcGain.gain.value = 1.7 * (0.5 - n.w)),
                    n.osc2.disconnect(),
                    n.osc2.panner.disconnect(),
                    n.osc2.amp(-1),
                    n.osc2.output.connect(n.dNode),
                    n.dNode.connect(n.output),
                    (n.output.gain.value = 1),
                    n.output.connect(n.panner),
                    n
                );
            }
            return (
                ...
                })(r, [
                    {
                        ...
                        value: function (t) {
                            if ('number' == typeof t) {
                                ...
                                var i = new I.a(-1),
                                    r = new I.a(1.7);
                                (n = n.connect(i).connect(r)).connect(
                                    this.dcGain.gain,
                                );
                            }
                        },
                        ...
                        value: function (t, e) {
                            ...
                            if (!this.started) {
                                ...
                                (this.oscillator =
                                    ...
                                    this.oscillator.connect(this.output),
                                    this.oscillator.start(i + n),
                                    (this.osc2.oscillator =
                                        p.audiocontext.createOscillator()),
                                    this.osc2.oscillator.frequency.setValueAtTime(
                                        r,
                                        i + n,
                                    ),
                                    (this.osc2.oscillator.type = o),
                                    this.osc2.oscillator.connect(
                                        this.osc2.output,
                                    ),
                                    this.osc2.start(i + n),
                                    (this.freqNode = [
                                    ...
                                    this.dcOffset.start(i + n),
                                    void 0 !== this.mods &&
                                        void 0 !== this.mods.frequency &&
                                        (this.mods.frequency.connect(
                                            this.freqNode[0],
                                        ),
                                        this.mods.frequency.connect(
                                            this.freqNode[1],
                    ...
                    },
                    {
                        ...
                        value: function (t, e, n) {
                            ...
                            if ('number' == typeof t) {
                                this.f = t;
                                var o = p.audiocontext.currentTime,
                                    s = this.oscillator.frequency.value;
                                this.oscillator.frequency.cancelScheduledValues(
                                    ...
                                    this.osc2.oscillator.frequency.cancelScheduledValues(
                                        o,
                                    ),
                                    this.osc2.oscillator.frequency.setValueAtTime(
                                        s,
                    ...
                    (function (t, e, n) {
                    ...
                    })(e, [
                        {
                            ...
                            value: function (e, n) {
                                ...
                                var t = p.inputSources[i.currentSource],
                                    r = {
                                        audio: {
                                            sampleRate:
                                                p.audiocontext.sampleRate,
                                ...
                                p.inputSources[this.currentSource] &&
                                    (r.audio.deviceId = t.deviceId),
                                    window.navigator.mediaDevices
                                        .getUserMedia(r)
                                        .then(function (t) {
                                            (i.stream = t),
                                                (i.enabled = !0),
                                                (i.mediaStream =
                                                    p.audiocontext.createMediaStreamSource(
                                                        t,
                                                    )),
                                                i.mediaStream.connect(i.output),
                                                i.amplitude.setInput(i.output),
                                                e && e();
                                        })
                                        .catch(function (t) {
                                            n && n(t);
                        ...
                        },
                        {
                            key: 'setSource',
                            value: function (t) {
                                0 < p.inputSources.length &&
                                    t < p.inputSources.length &&
        ...
        var Ct = (function () {
            function t() {
                !(function (t, e) {
                    ...
                    (this.ac = p.audiocontext),
                    (this.input = this.ac.createGain()),
                    (this.output = this.ac.createGain()),
                    (this._drywet = new At.a(1)),
            ...
            return (
                (function (t, e, n) {
                ...
                })(t, [
                    {
                        ...
                        value: function (t, e, n) {
                            var i =
                                ...
                                s = o + r,
                                a = s + i + 0.001,
                                u = this.output.gain.value;
                            this.output.gain.cancelScheduledValues(o),
                                this.output.gain.linearRampToValueAtTime(
                                    u,
                                    s + 0.001,
                                ),
                                this.output.gain.linearRampToValueAtTime(t, a);
                        },
                    },
                    {
                        key: 'chain',
                        value: function (t) {
                            if (0 < arguments.length) {
                                ...
                                for (var e = 1; e < arguments.length; e += 1)
                                    arguments[e - 1].connect(arguments[e]);
                            }
                            return this;
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            return (
                                void 0 !== t && (this._drywet.fade.value = t),
                        ...
                        value: function () {
                            ...
                            p.soundArray.splice(t, 1),
                                ...
                                this._drywet &&
                                    ...
                                    delete this._drywet),
                                this.wet &&
                                    (this.wet.disconnect(), delete this.wet),
                                (this.ac = void 0);
                        },
                    },
                ]),
        ...
        var Ft = (function () {
                function n(t) {
                    ...
                    return (
                        qt(this, n),
                        ((e = Nt(this, Vt(n).call(this))).biquad =
                            e.ac.createBiquadFilter()),
                        e.input.connect(e.biquad),
                        e.biquad.connect(e.wet),
                        t && e.setType(t),
                        (e._on = !0),
                        (e._untoggledType = e.biquad.type),
                        e
                    );
                }
                return (
                    ...
                    (function (t, e, n) {
                                ...
                                return (
                                    ...
                                    'number' == typeof t
                                        ? (this.biquad.frequency.cancelScheduledValues(
                                              this.ac.currentTime + 0.01 + n,
                                          ),
                                          this.biquad.frequency.exponentialRampToValueAtTime(
                                              t,
                                              this.ac.currentTime + 0.02 + n,
                                          ))
                        ...
                        },
                        {
                            key: 'dispose',
                            value: function () {
                                Bt(Vt(n.prototype), 'dispose', this).call(this),
                                    this.biquad &&
        ...
        var Yt = (function () {
            function i(t, e) {
                ...
                return (
                    ...
                    (n = Wt(this, Zt(i).call(this, 'peaking'))).disconnect(),
                    n.set(t, e),
                    (n.biquad.gain.value = 0),
                    delete n.input,
                    delete n.output,
                    delete n._drywet,
                    delete n.wet,
                ...
                (function (t, e, n) {
                    ...
                    { key: 'drywet', value: function () {} },
                    {
                        ...
                        value: function (t) {
                            var e = t || p5.soundOut.input;
                            this.biquad
                                ? this.biquad.connect(e.input ? e.input : e)
                                : this.output.connect(e.input ? e.input : e);
                        },
                    },
                    {
                        ...
                        o === t - 1
                            ...
                            : ((i =
                                  1 === o
                                      ...
                                      : e.bands[o - 1].freq() * n),
                              1)),
                        (e.bands[o] = e._newBand(i, r)),
                        0 < o
                            ? e.bands[o - 1].connect(e.bands[o].biquad)
                            : e.input.connect(e.bands[o].biquad);
            ...
            return (
                ...
                (function (t, e, n) {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            if (
                                (Jt(Kt(s.prototype), 'dispose', this).call(
                                    this,
                                ),
                                this.bands)
                            ) {
                        ...
                        value: function (t, e, n, i, r, o, s) {
                            return (
                                3 === arguments.length || 4 === arguments.length
                                    ? ((s = i), this.orientForward(t, e, n, s))
                                    : (6 !== arguments.length &&
                                          7 !== arguments) ||
                                      (this.orientForward(t, e, n),
                                      this.orientUp(i, r, o, s)),
                                [
        ...
        var le = (function () {
            function e() {
                ...
                return (
                    ...
                    ((t = se(this, ue(e).call(this))).panner =
                        t.ac.createPanner()),
                    (t.panner.panningModel = 'HRTF'),
                    (t.panner.distanceModel = 'linear'),
                    t.panner.connect(t.output),
                    t.input.connect(t.panner),
                    t
                );
            }
            return (
                ...
                (function (t, e, n) {
                    ...
                    },
                    {
                        key: 'dispose',
                        value: function () {
                            ae(ue(e.prototype), 'dispose', this).call(this),
                                this.panner &&
                                    (this.panner.disconnect(),
                                    delete this.panner);
                        },
        ...
        var ve = (function () {
            function e() {
                ...
                return (
                    ...
                    ((t = fe(this, ye(e).call(this)))._split =
                        t.ac.createChannelSplitter(2)),
                    (t._merge = t.ac.createChannelMerger(2)),
                    (t._leftGain = t.ac.createGain()),
                    (t._rightGain = t.ac.createGain()),
                    (t.leftDelay = t.ac.createDelay()),
                    (t.rightDelay = t.ac.createDelay()),
                    (t._leftFilter = new Gt()),
                    (t._rightFilter = new Gt()),
                    t._leftFilter.disconnect(),
                    t._rightFilter.disconnect(),
                    t._leftFilter.biquad.frequency.setValueAtTime(
                        1200,
                        t.ac.currentTime,
                    ),
                    t._rightFilter.biquad.frequency.setValueAtTime(
                        1200,
                        t.ac.currentTime,
                    ),
                    t._leftFilter.biquad.Q.setValueAtTime(
                        0.3,
                        t.ac.currentTime,
                    ),
                    t._rightFilter.biquad.Q.setValueAtTime(
                        0.3,
                        t.ac.currentTime,
                    ),
                    t.input.connect(t._split),
                    t.leftDelay.connect(t._leftGain),
                    t.rightDelay.connect(t._rightGain),
                    t._leftGain.connect(t._leftFilter.input),
                    t._rightGain.connect(t._rightFilter.input),
                    t._merge.connect(t.wet),
                    t._leftFilter.biquad.gain.setValueAtTime(
                        1,
                        t.ac.currentTime,
                    ),
                    t._rightFilter.biquad.gain.setValueAtTime(
                        1,
                        t.ac.currentTime,
                    ),
                    t.setType(0),
                    (t._maxDelay = t.leftDelay.delayTime.maxValue),
                    t.feedback(0.5),
                    t
                );
            }
                ...
                (function (t, e, n) {
                ...
                })(e, [
                    {
                        ...
                        value: function (t, e, n, i) {
                            ...
                            t.connect(this.input),
                                this.leftDelay.delayTime.setValueAtTime(
                                    o,
                                    this.ac.currentTime,
                                ),
                                this.rightDelay.delayTime.setValueAtTime(
                                    o,
                                    this.ac.currentTime,
                                ),
                                (this._leftGain.gain.value = r),
                                (this._rightGain.gain.value = r),
                                i &&
                                    (this._leftFilter.freq(i),
                                    this._rightFilter.freq(i));
                        },
                    },
                    {
                        key: 'delayTime',
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            if (t && 'number' != typeof t)
                                ...
                                'number' == typeof t &&
                                    ((this._leftGain.gain.value = t),
                                    (this._rightGain.gain.value = t));
                            }
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            switch (
                                ...
                                case 'pingPong':
                                    this._rightFilter.setType(
                                        this._leftFilter.biquad.type,
                                    ),
                    ...
                    },
                    {
                        key: 'dispose',
                        value: function () {
                            de(ye(e.prototype), 'dispose', this).call(this),
                                this._split.disconnect(),
        ...
        var Ae = (function () {
                function e() {
                    ...
                    return (
                        ge(this, e),
                        (t = we(this, Se(e).call(this)))._initConvolverNode(),
                        (t.input.gain.value = 0.5),
                        (t._seconds = 3),
                        (t._decay = 2),
                        (t._reverse = !1),
                        t._buildImpulse(),
                    ...
                    Te(e, [
                        ...
                        },
                        {
                            ...
                            value: function (t, e, n, i) {
                                t.connect(this.input);
                                var r = !1;
                                e && ((this._seconds = e), (r = !0)),
                                    n && (this._decay = n),
                                    i && (this._reverse = i),
                                    r && this._buildImpulse();
                            },
                        },
                        {
                            key: 'set',
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t,
                                    e,
                                    n = this.ac.sampleRate,
                                    i = n * this._seconds,
                                    r = this._decay,
                                    o = this.ac.createBuffer(2, i, n),
                                    s = o.getChannelData(0),
                                    a = o.getChannelData(1);
                                for (e = 0; e < i; e++)
                                    (t = this._reverse ? i - e : e),
                                        (s[e] =
                                            (2 * Math.random() - 1) *
                                            Math.pow(1 - t / i, r)),
                                        (a[e] =
                        ...
                        },
                        {
                            key: 'dispose',
                            value: function () {
                                xe(Se(e.prototype), 'dispose', this).call(this),
                                    this._teardownConvolverNode();
                            },
                        },
                    ]),
            ...
            Oe = (function () {
                function r(t, e, n) {
                    ...
                    return (
                        ge(this, r),
                        (i = we(this, Se(r).call(this)))._initConvolverNode(),
                        (i.input.gain.value = 0.5),
                        t
                            ? ((i.impulses = []), i._loadBuffer(t, e, n))
                            : ((i._seconds = 3),
                              (i._decay = 2),
                              (i._reverse = !1),
                              i._buildImpulse()),
                            ...
                            value: function (t) {
                                if (
                                    ('number' == typeof t &&
                                        ...
                                        this._setBuffer(
                                            this.impulses[t].audioBuffer,
                                        ),
                                    'string' == typeof t)
                                )
                                    for (
                                        var e = 0;
                                        e < this.impulses.length;
                                        e++
                                    )
                                        if (this.impulses[e].name === t) {
                                            this._setBuffer(
                                                this.impulses[e].audioBuffer,
                                            );
                                            break;
                                        }
                            },
                ...
                (function (t, e, n) {
                ...
                })(t, [
                    {
                        ...
                        value: function (t) {
                            var e = t - this.prevTick,
                                i = t - p.audiocontext.currentTime;
                                ...
                                this.syncedParts.forEach(function (t) {
                                    t.isPlaying &&
                                        ...
                                        t.phrases.forEach(function (t) {
                                            var e = t.sequence,
                                                n = r.metroTicks % e.length;
                                            0 !== e[n] &&
                                                (r.metroTicks < e.length ||
                                                    !t.looping) &&
                                                t.callback(i, e[n]);
                                        }));
                                }),
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            (this.tatumTime = i),
                                this.clock.frequency.setValueAtTime(
                                    this.clock.frequency.value,
                                    r,
                                ),
                                this.clock.frequency.linearRampToValueAtTime(
                                    t,
                                    r + n,
                                ),
                                (this.bpm = t);
        ...
        p5.prototype.setBPM = function (t, e) {
            for (var n in ((je = t), p.parts))
                p.parts[n] && p.parts[n].setBPM(t, e);
        };
        function Me(t, e, n) {
            Ve(this, Me),
                (this.phraseStep = 0),
        ...
        var Fe = (function () {
                function n(t, e) {
                    Ve(this, n),
                        ...
                        (this.isPlaying = !1),
                        this.noLoop(),
                        (this.tatums = e || 0.0625),
                        (this.metro = new Ee()),
                        this.metro._init(),
                        this.metro.beatLength(this.tatums),
                        this.metro.setBPM(je),
                        p.parts.push(this),
                    ...
                    Be(n, [
                        ...
                        },
                        {
                            ...
                            value: function (t, e, n) {
                                ...
                                this.phrases.push(i),
                                    i.sequence.length > this.length &&
                                        (this.length = i.sequence.length);
                            },
                        },
                        {
                            key: 'removePhrase',
                            value: function (t) {
                                for (var e in this.phrases)
                                    this.phrases[e].name === t &&
                                        this.phrases.splice(e, 1);
                            },
                        },
                        {
                            key: 'getPhrase',
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                for (var n in this.phrases)
                                    this.phrases[n].name === t &&
                                        (this.phrases[n].sequence = e);
                            },
                        },
                        {
                            key: 'incrementStep',
            ...
            De = (function () {
                function n() {
                    ...
                    for (var e in arguments)
                        (this.parts[e] = arguments[e]),
                            (this.parts[e].nextPart = this.parts[e + 1]),
                            (this.parts[e].onended = function () {
                                t.resetPart(e), Ie(t);
                            });
                    this.looping = !1;
                }
                return (
                    Be(n, [
                        ...
                        },
                        {
                            key: 'resetPart',
                            value: function (t) {
                                for (var e in (this.parts[t].stop(),
                                (this.parts[t].partStep = 0),
                                this.parts[t].phrases))
                                    this.parts[t] &&
                                        (this.parts[t].phrases[
                                            e
                                        ].phraseStep = 0);
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                for (var n in this.parts)
                                    this.parts[n] && this.parts[n].setBPM(t, e);
                            },
                        },
                    ]),
                    n
            ...
            function i(t, e) {
                !(function (t, e) {
                    ...
                    Object.defineProperty(this, 'interval', {
                        ...
                        set: function (t) {
                            (this.musicalTimeMode = 'number' != typeof t),
                                (this._interval = t),
                                this._update();
                        },
                    }),
            ...
            return (
                (function (t, e, n) {
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var e = t || 0,
                                n = p.audiocontext.currentTime;
                            this.isPlaying &&
                                (this.clock.stop(n + e), (this.isPlaying = !1));
                        },
                    },
                    {
                        key: 'pause',
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            var n = e || 0,
                                i = p.audiocontext.currentTime;
                            if (t.isPlaying) {
                                if (t.isPlaying) {
                                    var r =
                                        t.clock._nextTick -
                                        p.audiocontext.currentTime;
                                    this.clock.start(i + r),
                                        (this.isPlaying = !0);
                                }
                            } else
                                t.clock.start(i + n),
                                    (t.isPlaying = !0),
                                    this.clock.start(i + n),
                                    (this.isPlaying = !0);
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return 'number' == typeof this._interval
                                ? ((this.musicalTimeMode = !1),
                                  1 / this._interval)
                                : 'string' == typeof this._interval
                                ? ((this.musicalTimeMode = !0),
                                  (this._bpm /
                                      60 /
                                      this._convertNotation(this._interval)) *
                                      (this._timeSignature / 4))
                                : void 0;
                        },
                    },
        ...
        var He = (function () {
            function e() {
                ...
                return (
                    ...
                    ((t = We(this, Xe(e).call(this))).compressor =
                        t.ac.createDynamicsCompressor()),
                    t.input.connect(t.compressor),
                    t.compressor.connect(t.wet),
                    t
                );
            }
            return (
                ...
                (function (t, e, n) {
                    ...
                    },
                    {
                        key: 'set',
                        value: function (t, e, n, i, r) {
                            void 0 !== t && this.attack(t),
                                void 0 !== e && this.knee(e),
                                void 0 !== n && this.ratio(n),
                                void 0 !== i && this.threshold(i),
                                void 0 !== r && this.release(r);
                        },
                    },
                    {
                        key: 'attack',
                        value: function (t, e) {
                            ...
                            return (
                                'number' == typeof t
                                    ...
                                    : void 0 !== t &&
                                      t.connect(this.compressor.attack),
                        ...
                        value: function (t, e) {
                            ...
                            return (
                                'number' == typeof t
                                    ...
                                    : void 0 !== t &&
                                      t.connect(this.compressor.knee),
                        ...
                        value: function (t, e) {
                            ...
                            return (
                                'number' == typeof t
                                    ...
                                    : void 0 !== t &&
                                      t.connect(this.compressor.ratio),
                        ...
                        value: function (t, e) {
                            ...
                            return (
                                'number' == typeof t
                                    ...
                                    : void 0 !== t &&
                                      t.connect(this.compressor.threshold),
                    ...
                    },
                    {
                        key: 'dispose',
                        value: function () {
                            Ze(Xe(e.prototype), 'dispose', this).call(this),
                                this.compressor &&
        ...
        var Qe = (function () {
            function r(t, e, n, i) {
                !(function (t, e) {
                    ...
                    (this.framesPerPeak = i || 20),
                    (this.framesSinceLastPeak = 0),
                    (this.decayRate = 0.95),
                    (this.threshold = n || 0.35),
                    (this.cutoff = 0),
                    (this.cutoffMult = 1.5),
                    (this.energy = 0),
                    (this.penergy = 0),
            ...
            return (
                (function (t, e, n) {
                ...
                })(r, [
                    {
                        ...
                        value: function (t) {
                            var e = (this.energy =
                                t.getEnergy(this.f1, this.f2) / 255);
                            e > this.cutoff &&
                            e > this.threshold &&
                            0 < e - this.penergy
                                ? (this._onPeak(),
            ...
            tn = (function () {
                function e() {
                    !(function (t, e) {
                        ...
                        (this.input = Ke.createGain()),
                        (this.output = Ke.createGain()),
                        (this._inputChannels = 2),
                        (this._outputChannels = 2);
                    var t = y(1024);
                    (this._workletNode = new AudioWorkletNode(
                        Ke,
                        s.a.recorderProcessor,
                        {
        ...
        function un(t) {
            for (
                var e,
                    n = 'number' == typeof t ? t : 50,
                    i = new Float32Array(44100),
                    r = Math.PI / 180,
                    o = 0;
                o < 44100;
                ++o
                ...
                (e = (2 * o) / 44100 - 1),
                    (i[o] =
                        ((3 + n) * e * 20 * r) / (Math.PI + n * Math.abs(e)));
            return i;
        }
        var cn = (function () {
            function r(t, e) {
                ...
                if (
                    ...
                    (n = rn(this, sn(r).call(this))),
                    void 0 === t && (t = 0.25),
                    'number' != typeof t)
                )
                    throw new Error('amount must be a number');
                if ((void 0 === e && (e = '2x'), 'string' != typeof e))
                    throw new Error('oversample must be a String');
                var i = p5.prototype.map(t, 0, 1, 0, 2e3);
                return (
                    (n.waveShaperNode = n.ac.createWaveShaper()),
                    (n.amount = i),
                    (n.waveShaperNode.curve = un(i)),
                    (n.waveShaperNode.oversample = e),
                    n.input.connect(n.waveShaperNode),
                    n.waveShaperNode.connect(n.wet),
                    n
                );
            }
            return (
                ...
                (function (t, e, n) {
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            if (t) {
                                ...
                                (this.amount = n),
                                    (this.waveShaperNode.curve = un(n));
                            }
                    ...
                    },
                    {
                        key: 'dispose',
                        value: function () {
                            on(sn(r.prototype), 'dispose', this).call(this),
                                this.waveShaperNode &&
        ...
        var fn = (function () {
            ...
            return (
                (function (t, e, n) {
                    ...
                    { key: 'play', value: function (t, e, n, i) {} },
                    { key: 'triggerAttack', value: function (t, e, n) {} },
                    { key: 'triggerRelease', value: function (t) {} },
                    { key: 'amp', value: function (t, e) {} },
                    {
                        key: 'connect',
                        value: function (t) {
                            var e = t || p.input;
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.output &&
                                (this.output.disconnect(), delete this.output);
                        },
                    },
                ]),
                t
        ...
        var bn = (function () {
            function e() {
                ...
                return (
                    ...
                    ((t = (function (t, e) {
                        return !e ||
                            ('object' !== dn(e) && 'function' != typeof e)
                            ? mn(t)
                            : e;
                    })(this, _n(e).call(this))).oscillator = new nt()),
                    (t.env = new ot()),
                    t.env.setRange(1, 0),
                    t.env.setExp(!0),
                    t.setADSR(0.02, 0.25, 0.05, 0.35),
                    t.oscillator.disconnect(),
                    t.oscillator.connect(t.output),
                    t.env.disconnect(),
                    t.env.setInput(t.output.gain),
                    (t.oscillator.output.gain.value = 1),
                    t.oscillator.start(),
                    t.connect(),
                    p.soundArray.push(mn(t)),
                    Object.defineProperties(mn(t), {
                        attack: {
                            get: function () {
            ...
            return (
                ...
                (function (t, e, n) {
                ...
                })(e, [
                    {
                        key: 'play',
                        value: function (t, e, n, i) {
                            this.triggerAttack(t, e, ~~n),
                                this.triggerRelease(~~n + (i || 0.15));
                        },
                    },
                    {
                        key: 'triggerAttack',
                        value: function (t, e, n) {
                            var i =
                                ...
                                r = h(t),
                                o = e || 0.1;
                            this.oscillator.freq(r, 0, i),
                                this.env.ramp(this.output.gain, i, o);
                        },
                    },
                    {
                        key: 'triggerRelease',
                        value: function (t) {
                            var e =
                                0 < arguments.length && void 0 !== t ? t : 0;
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            var n = e || 0;
                            return (
                                void 0 !== t && this.oscillator.amp(t, n),
                    ...
                    },
                    {
                        key: 'dispose',
                        value: function () {
                            vn(_n(e.prototype), 'dispose', this).call(this),
                ...
                (function (t, e, n) {
                ...
                })(r, [
                    {
                        ...
                        value: function (t, e) {
                            if (
                                ((this.energy =
                                    t.getEnergy(this.freqLow, this.freqHigh) /
                                    255),
                                !1 === this.isDetected &&
                                    this.energy - this.penergy > this.treshold)
                            ) {
                                (this.isDetected = !0),
                                    this.callback
        ...
        var Sn = (function () {
            function n(t, e) {
                !(function (t, e) {
                    ...
                    (this._oldest = 0),
                    (this.maxVoices = e || 8),
                    (this.AudioVoice = void 0 === t ? p5.MonoSynth : t),
                    (this._voicesInUse = new rt.a(0)),
                    (this.output = p.audiocontext.createGain()),
                    this.connect(),
            ...
            return (
                (function (t, e, n) {
                    ...
                    },
                    {
                        ...
                        value: function (t, e, n, i) {
                            var r =
                                3 < arguments.length && void 0 !== i ? i : 1;
                            this.noteAttack(t, e, n),
                                this.noteRelease(t, n + r);
                        },
                    },
                    {
                        key: 'noteADSR',
                        value: function (t, e, n, i, r, o) {
                            var s =
                                    5 < arguments.length && void 0 !== o
                                        ? o
                                        : 0,
                                a = p.audiocontext.currentTime + s;
                            this.audiovoices[
                                this.notes[t].getValueAtTime(a)
                            ].setADSR(e, n, i, r);
                        },
                    },
                    {
                            ...
                            var i,
                                r =
                                    2 < arguments.length && void 0 !== n
                                        ? n
                                        : 0,
                                o = p.audiocontext.currentTime + r,
                                s = h(t),
                                a = e || 0.1;
                            this.notes[s] &&
                                null !== this.notes[s].getValueAtTime(o) &&
                                this.noteRelease(s, 0),
                                this._voicesInUse.getValueAtTime(o) <
                                this.maxVoices
                                    ? (i = Math.max(
                                          ~~this._voicesInUse.getValueAtTime(o),
                                          0,
                                    ...
                                    : ((i = this._oldest),
                                      ...
                                      (this._oldest =
                                          (this._oldest + 1) %
                                          (this.maxVoices - 1))),
                                (this.notes[s] = new rt.a()),
                                this.notes[s].setValueAtTime(i, o);
                            var u =
                                null === this._voicesInUse._searchBefore(o)
                                    ? 0
                                    : this._voicesInUse._searchBefore(o).value;
                            if (
                                (this._voicesInUse.setValueAtTime(u + 1, o),
                                this._updateAfter(o, 1),
                                (this._newest = i),
                                'number' == typeof a)
                            ) {
                                var c =
                                    (1 / this._voicesInUse.getValueAtTime(o)) *
                                    2;
                                a = c < a ? c : a;
                            }
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            if (t) {
                                ...
                                if (
                                    this.notes[o] &&
                                    null !== this.notes[o].getValueAtTime(r)
                                ) {
                                    var s = Math.max(
                                        ~~this._voicesInUse.getValueAtTime(r)
                                            .value,
                                        1,
                                    );
                                    this._voicesInUse.setValueAtTime(s - 1, r),
                                        0 < s && this._updateAfter(r, -1),
                                        this.audiovoices[
                                            this.notes[o].getValueAtTime(r)
                                        ].triggerRelease(i),
                                        this.notes[o].dispose(),
                                        delete this.notes[o],
                                        (this._newest =
                                            0 === this._newest
                                                ? 0
                                ...
                                for (var a in (this.audiovoices.forEach(
                                    function (t) {
                                        t.triggerRelease(i);
                                    },
                                ),
                                this._voicesInUse.setValueAtTime(0, r),
                                this.notes))
        ...
        (p5.prototype.getAudioContext = c.b),
            (p5.prototype.userStartAudio = c.c),
            (p5.prototype.sampleRate = function () {
                return p.audiocontext.sampleRate;
            }),
            (p5.prototype.freqToMidi = l),
            (p5.prototype.midiToFreq = r),
            (p5.prototype.noteToFreq = h),
            ...
            (p5.prototype.disposeSound = function () {
                for (var t = 0; t < p.soundArray.length; t++)
                    p.soundArray[t].dispose();
            }),
            (p5.prototype._checkFileFormats = function (t) {
                ...
                if ('string' == typeof t) {
                    ...
                    if (-1 < ['mp3', 'wav', 'ogg', 'm4a', 'aac'].indexOf(n)) {
                        if (!p5.prototype.isFileSupported(n))
                            for (
                                var i = e.split('.'),
                                    r = i[i.length - 1],
                                    o = 0;
                                o < p.extensions.length;
                                o++
                            ) {
                                var s = p.extensions[o];
                                if (p5.prototype.isFileSupported(s)) {
                                    (r = ''), 2 === i.length && (r += i[0]);
                                    for (var a = 1; a <= i.length - 2; a++) {
                                        r += '.' + i[a];
                                    }
                                    (e = r += '.'), (e = e += s);
                                    break;
                        ...
                        for (var u = 0; u < p.extensions.length; u++) {
            ...
            (p5.prototype._mathChain = function (t, e, n, i, r) {
                for (var o in t.mathOps)
                    t.mathOps[o] instanceof r &&
                        (t.mathOps[o].dispose(),
                        (n = o) < t.mathOps.length - 1 &&
                            (i = t.mathOps[o + 1]));
                return (
                    t.mathOps[n - 1].disconnect(),
                    t.mathOps[n - 1].connect(e),
                    e.connect(i),
                    (t.mathOps[n] = e),
                    t
                );
            }),
            (p5.prototype.convertToWav = a),
            (p5.prototype.interleave = u),
            (p5.prototype.writeUTFBytes = d),
            (p5.prototype.safeBufferSize = y),
            ...
            (p5.Panner = k),
            (p5.SoundFile = E),
            (p5.prototype.loadSound = function (t, e, n, i) {
                ...
                return new q(
                    t,
                    function () {
                        'function' == typeof e && e.apply(r, arguments),
            ...
            (p5.Reverb = Ae),
            (p5.Convolver = Oe),
            (p5.prototype.createConvolver = function (t, e, n) {
                -1 < window.location.origin.indexOf('file://') &&
                    'undefined' === window.cordova &&
                    alert(
                        'This sketch may require a server to load external files. Please see http://bit.ly/1qcInwS',
                    ...
                    r = new Oe(
                        ...
                        function (t) {
                            'function' == typeof e && e(t),
                                'function' == typeof i._decrementPreload &&
                                    i._decrementPreload();
                        },
                        n,
                    );
